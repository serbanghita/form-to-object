...
class FormToObject {
    ...
    initForm() {
        ...
        else if ((0, dom_1.isDomElementNode)(this.formSelector)) {
    ...
    initFormElements() {
        ...
        this.$formElements = (0, dom_1.getAllFormElementsAsArray)(this.$form);
    ...
    convertToObj() {
        ...
        for (i = 0; i < this.$formElements.length; i++) {
            ...
            if (objKeyNames && objKeyNames.length > 1) {
                if ((0, dom_1.isSelectMultiple)($domNode) && this.settings.selectNameWithEmptyBracketsReturnsArray) {
                ...
                if ((0, dom_1.isCheckbox)($domNode) && this.settings.checkBoxNameWithEmptyBracketsReturnsArray) {
                    if (objKeyNames.length === 2 && objKeyNames[1] === '[]') {
                        objKeyNames = [objKeyNames[0]];
                    }
                }
        ...
        if (arr.length > 1) {
            if (keyName === '[]') {
                ...
                if (result[keyName] && (0, utils_1.getObjLength)(result[keyName]) > 0) {
                    ...
                    if ((0, dom_1.isSelectMultiple)($domNode) && arr.length >= 2 && arr[1] === '[]') {
                        result[keyName] = [];
                    }
                    else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isFileList = exports.isChecked = exports.isSubmitButton = exports.isSelectMultiple = exports.isSelectSimple = exports.isTextarea = exports.isFileField = exports.isCheckbox = exports.isRadio = exports.isUploadForm = exports.isDomElementNode = exports.getAllFormElementsAsArray = void 0;
/**
 ...
 * @param $form
 */
function getAllFormElementsAsArray($form) {
    if ('querySelectorAll' in $form) {
        return [...$form === null || $form === void 0 ? void 0 : $form.querySelectorAll('input, textarea, select')];
    }
...
exports.getAllFormElementsAsArray = getAllFormElementsAsArray;
/**
