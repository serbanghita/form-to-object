...
import {init as formToObject} from "../../src/core";
...
describe('checkbox', function(){
  ...
  it('A form with a single checkbox without value attribute should return the default value "on" as a string.', () => {
  ...
  it('A form with two checkboxes with different values attributes should return the checked element value as an array', () => {
    const html = '<form id="newForm">' +
  ...
  it('A form with various checkboxes should return the expected object.', () => {
    const html = '' +
      '<form id="newForm">' +
      // Should be ignored.
